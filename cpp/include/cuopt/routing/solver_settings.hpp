...
class solver_settings_t {
 public:
   ...
   *
   * @param[in] callback Pointer to callback object (void* for Python bindings)
   */
  void set_routing_callback(callbacks::base_routing_callback_t* callback);
  
  /**
   * @brief Set a callback for routing solver (void* version for Python bindings)
   *
   * @param[in] callback Pointer to callback object as void*
   */
  void set_routing_callback(void* callback);
